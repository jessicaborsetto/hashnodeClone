            ...
            <Navbar.Collapse id="navbar-light-example">
                ...
                >
                    <NavDropdown.Item href="#action/3.1" className='flex gap-3 py-2 px-4 text-sm '>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-compass" viewBox="0 0 16 16" className='menuIcon'>
                            <path d="M8 16.016a7.5 7.5 0 0 0 1.962-14.74A1 1 0 0 0 9 0H7a1 1 0 0 0-.962 1.276A7.5 7.5 0 0 0 8 16.016m6.5-7.5a6.5 6.5 0 1 1-13 0 6.5 6.5 0 0 1 13 0" />
                            <path d="m6.94 7.44 4.95-2.83-2.83 4.95-4.949 2.83 2.828-4.95z" />
                        </svg> <p className='dropColor'>Explore</p></NavDropdown.Item>

                    <NavDropdown.Item href="#action/3.1" className='flex gap-3 py-2 px-4 text-sm'>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className='menuIcon'>
                    ...
                    <NavDropdown.Item href="#action/3.1" className='flex gap-3 py-2 px-4 text-sm'>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-diagram-2" viewBox="0 0 16 16" className='menuIcon'>
                    ...
                    <NavDropdown.Item href="#action/3.1" className='flex gap-3 py-2 px-4 text-sm'>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-broadcast-pin" viewBox="0 0 16 16" className='menuIcon'>
                    ...
                    <NavDropdown.Item href="#action/3.1" className='flex gap-3 py-2 px-4 text-sm'>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-phone" viewBox="0 0 16 16" className='menuIcon'>
